...
MySQL - 5.0.20-nt : Database - edumore
*********************************************************************
*/
...
insert  into `enquiry_details`(`enquiry_id`,`first_name`,`middle_name`,`last_name`,`residence_number`,`mobile_number`,`email_id`,`date_of_birth`,`gender`,`father_first_name`,`father_middle_name`,`father_last_name`,`father_mobile_number`,`father_residence_number`,`current_address`,`permanent_address`,`counsellor_id`,`enquiry_number`) values (1,'Sachit Kesri',NULL,NULL,'9971840843',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,00000000000000000000,1,0),(2,'ssss','','','','',NULL,'','','','','null','null','null',00000000000000000031,00000000000000000032,1,1399342441182),(3,'asd','hgj','gjh','gjh','gjh',NULL,'g','jh','g','jhg','jh','g','ghj',00000000000000000033,00000000000000000034,1,1399342483749),(4,'','','','','',NULL,'','','','','','','',00000000000000000035,00000000000000000036,1,1400597715049);
...
insert  into `followup_details`(`followup_id`,`date`,`remarks`,`enquiry_id`) values (1,'2013-12-09','test remark',1),(2,'2013-12-09','sda',1);
