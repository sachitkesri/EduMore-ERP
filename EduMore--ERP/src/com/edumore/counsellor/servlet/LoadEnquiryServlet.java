...
public class LoadEnquiryServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(enquiryBean != null){
				request.setAttribute("enquiryBean" , enquiryBean);
			}else{
			...
			request.setAttribute("loadEnquiryStatusMsg", "Error occured while loading enquiries");
			request.setAttribute("loadEnquiryStatusMsgColor", "red");
		} finally{
			RequestDispatcher dispatcher = request.getRequestDispatcher("admissionForm.jsp");
